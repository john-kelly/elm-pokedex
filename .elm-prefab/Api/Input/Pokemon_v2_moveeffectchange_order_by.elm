module Api.Input.Pokemon_v2_moveeffectchange_order_by exposing (Pokemon_v2_moveeffectchange_order_by, id, input, move_effect_id, null, pokemon_v2_moveeffect, pokemon_v2_moveeffectchangeeffecttexts_aggregate, pokemon_v2_versiongroup, version_group_id)

{-| 
## Creating an input

@docs pokemon_v2_moveeffectchange_order_by, input
...
@docs id, move_effect_id, pokemon_v2_moveeffect, pokemon_v2_moveeffectchangeeffecttexts_aggregate, pokemon_v2_versiongroup, version_group_id
-}
...
input =
    GraphQL.InputObject.inputObject "pokemon_v2_moveeffectchange_order_by"
