module Api.Input.Pokemon_v2_itemattribute_order_by exposing (Pokemon_v2_itemattribute_order_by, id, input, name, null, pokemon_v2_itemattributedescriptions_aggregate, pokemon_v2_itemattributemaps_aggregate, pokemon_v2_itemattributenames_aggregate)

{-| 
## Creating an input

@docs pokemon_v2_itemattribute_order_by, input
...
@docs id, name, pokemon_v2_itemattributedescriptions_aggregate, pokemon_v2_itemattributemaps_aggregate, pokemon_v2_itemattributenames_aggregate
-}
...
input =
    GraphQL.InputObject.inputObject "pokemon_v2_itemattribute_order_by"
