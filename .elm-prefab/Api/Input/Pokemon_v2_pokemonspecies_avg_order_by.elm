module Api.Input.Pokemon_v2_pokemonspecies_avg_order_by exposing (Pokemon_v2_pokemonspecies_avg_order_by, base_happiness, capture_rate, evolution_chain_id, evolves_from_species_id, gender_rate, generation_id, growth_rate_id, hatch_counter, id, input, null, order, pokemon_color_id, pokemon_habitat_id, pokemon_shape_id)

{-| 
## Creating an input

@docs pokemon_v2_pokemonspecies_avg_order_by, input
...
input =
    GraphQL.InputObject.inputObject "pokemon_v2_pokemonspecies_avg_order_by"
