module Api.Input.Pokemon_v2_moveeffectchangeeffecttext_bool_exp exposing (Pokemon_v2_moveeffectchangeeffecttext_bool_exp, and, effect, id, input, language_id, move_effect_change_id, not, null, or, pokemon_v2_language, pokemon_v2_moveeffectchange)

{-| 
## Creating an input

@docs pokemon_v2_moveeffectchangeeffecttext_bool_exp, input
...
@docs and, not, or, effect, id, language_id, move_effect_change_id, pokemon_v2_language, pokemon_v2_moveeffectchange
-}
...
and :
    List Api.Input.Pokemon_v2_moveeffectchangeeffecttext_bool_exp
    -> Pokemon_v2_moveeffectchangeeffecttext_bool_exp
    -> Pokemon_v2_moveeffectchangeeffecttext_bool_exp
