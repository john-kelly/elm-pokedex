module Api.Input.Pokemon_v2_movemeta_stddev_pop_order_by exposing (Pokemon_v2_movemeta_stddev_pop_order_by, ailment_chance, crit_rate, drain, flinch_chance, healing, id, input, max_hits, max_turns, min_hits, min_turns, move_id, move_meta_ailment_id, move_meta_category_id, null, stat_chance)

{-| 
## Creating an input

@docs pokemon_v2_movemeta_stddev_pop_order_by, input
...
input =
    GraphQL.InputObject.inputObject "pokemon_v2_movemeta_stddev_pop_order_by"
