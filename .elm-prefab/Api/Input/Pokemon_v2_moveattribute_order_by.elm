module Api.Input.Pokemon_v2_moveattribute_order_by exposing (Pokemon_v2_moveattribute_order_by, id, input, name, null, pokemon_v2_moveattributedescriptions_aggregate, pokemon_v2_moveattributemaps_aggregate, pokemon_v2_moveattributenames_aggregate)

{-| 
## Creating an input

@docs pokemon_v2_moveattribute_order_by, input
...
@docs id, name, pokemon_v2_moveattributedescriptions_aggregate, pokemon_v2_moveattributemaps_aggregate, pokemon_v2_moveattributenames_aggregate
-}
...
input =
    GraphQL.InputObject.inputObject "pokemon_v2_moveattribute_order_by"
