module Api.Input.Pokemon_v2_pokemonhabitat_bool_exp exposing (Pokemon_v2_pokemonhabitat_bool_exp, and, id, input, name, not, null, or, pokemon_v2_pokemonhabitatnames, pokemon_v2_pokemonhabitatnames_aggregate, pokemon_v2_pokemonspecies, pokemon_v2_pokemonspecies_aggregate)

{-| 
## Creating an input

@docs pokemon_v2_pokemonhabitat_bool_exp, input
...
@docs and, not, or, id, name, pokemon_v2_pokemonhabitatnames, pokemon_v2_pokemonhabitatnames_aggregate, pokemon_v2_pokemonspecies, pokemon_v2_pokemonspecies_aggregate
-}
...
input =
    GraphQL.InputObject.inputObject "pokemon_v2_pokemonhabitat_bool_exp"


and :
    List Api.Input.Pokemon_v2_pokemonhabitat_bool_exp
