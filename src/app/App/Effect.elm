...
type Effect msg
    ...
    -- User Defined
    | Graphql (Api.Query msg) (GraphQL.Engine.Error -> msg)
...
toCmd options effect =
    case effect of
        ...
        Graphql query errorToMsg ->
            ...
            |> Cmd.map (Result.mapError errorToMsg)
            |> Cmd.map (unwrapResult)
...
map f effect =
    case effect of
        ...
        Graphql query errorToMsg ->
            Graphql (Api.map f query) (errorToMsg >> f)
