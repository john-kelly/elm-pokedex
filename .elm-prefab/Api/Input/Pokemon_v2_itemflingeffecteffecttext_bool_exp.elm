module Api.Input.Pokemon_v2_itemflingeffecteffecttext_bool_exp exposing (Pokemon_v2_itemflingeffecteffecttext_bool_exp, and, effect, id, input, item_fling_effect_id, language_id, not, null, or, pokemon_v2_itemflingeffect, pokemon_v2_language)

{-| 
## Creating an input

@docs pokemon_v2_itemflingeffecteffecttext_bool_exp, input
...
@docs and, not, or, effect, id, item_fling_effect_id, language_id, pokemon_v2_itemflingeffect, pokemon_v2_language
-}
...
and :
    List Api.Input.Pokemon_v2_itemflingeffecteffecttext_bool_exp
    -> Pokemon_v2_itemflingeffecteffecttext_bool_exp
    -> Pokemon_v2_itemflingeffecteffecttext_bool_exp
