module Api.Input.Pokemon_v2_encounterconditionvaluename_bool_exp exposing (Pokemon_v2_encounterconditionvaluename_bool_exp, and, encounter_condition_value_id, id, input, language_id, name, not, null, or, pokemon_v2_encounterconditionvalue, pokemon_v2_language)

{-| 
## Creating an input

@docs pokemon_v2_encounterconditionvaluename_bool_exp, input
...
@docs and, not, or, encounter_condition_value_id, id, language_id, name, pokemon_v2_encounterconditionvalue, pokemon_v2_language
-}
...
and :
    List Api.Input.Pokemon_v2_encounterconditionvaluename_bool_exp
    -> Pokemon_v2_encounterconditionvaluename_bool_exp
    -> Pokemon_v2_encounterconditionvaluename_bool_exp
