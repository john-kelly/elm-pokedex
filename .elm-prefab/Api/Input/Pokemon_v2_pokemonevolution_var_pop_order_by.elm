module Api.Input.Pokemon_v2_pokemonevolution_var_pop_order_by exposing (Pokemon_v2_pokemonevolution_var_pop_order_by, evolution_item_id, evolution_trigger_id, evolved_species_id, gender_id, held_item_id, id, input, known_move_id, known_move_type_id, location_id, min_affection, min_beauty, min_happiness, min_level, null, party_species_id, party_type_id, relative_physical_stats, trade_species_id)

{-| 
## Creating an input

@docs pokemon_v2_pokemonevolution_var_pop_order_by, input
