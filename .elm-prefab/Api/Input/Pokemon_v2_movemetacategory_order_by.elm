module Api.Input.Pokemon_v2_movemetacategory_order_by exposing (Pokemon_v2_movemetacategory_order_by, id, input, name, null, pokemon_v2_movemeta_aggregate, pokemon_v2_movemetacategorydescriptions_aggregate)

{-| 
## Creating an input

@docs pokemon_v2_movemetacategory_order_by, input
...
@docs id, name, pokemon_v2_movemeta_aggregate, pokemon_v2_movemetacategorydescriptions_aggregate
-}
...
input =
    GraphQL.InputObject.inputObject "pokemon_v2_movemetacategory_order_by"
